...
function downloadPageCss() {
  return `
    :root{--accent:#0f766e;--accent-dark:#115e59;--bg:#f5fbf9;--text:#0f172a;--muted:#5f6f78;--border:#d8ebe6;--panel:#fff;--code:#10201d;--code-text:#d9fff2;--shadow:0 12px 30px rgba(15,118,110,.08)}
    *{box-sizing:border-box}body{margin:0;min-height:100vh;background:linear-gradient(180deg,#fff 0%,var(--bg) 50%,#edf7f4 100%);color:var(--text);font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}
    ...
    .hero-copy,.download-panel,.mini-card,.examples,.note-panel{background:rgba(255,255,255,.92);border:1px solid var(--border);border-radius:8px;box-shadow:var(--shadow)}
    .hero-copy{padding:26px;border-left:6px solid var(--accent);display:flex;flex-direction:column;justify-content:center}
    .status{align-self:flex-start;background:#f0fdfa;color:var(--accent-dark);border:1px solid #99f6e4;border-radius:999px;padding:6px 10px;font-size:12px;font-weight:900;text-transform:uppercase}
    ...
    .download-btn{display:inline-flex;align-items:center;justify-content:center;min-height:40px;border-radius:8px;background:var(--accent);color:#fff;text-decoration:none;font-size:13px;font-weight:900}.download-btn:hover{background:var(--accent-dark)}
    .command-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-bottom:14px}.mini-card{overflow:hidden}.mini-head{display:flex;align-items:center;justify-content:space-between;gap:10px;min-height:50px;padding:12px 14px;border-bottom:1px solid var(--border)}.mini-head span{font-size:13px;font-weight:900;text-transform:uppercase}.mini-head button{min-height:32px;border:1px solid var(--accent);background:var(--accent);color:#fff;border-radius:8px;padding:0 11px;font-size:12px;font-weight:900;cursor:pointer}
